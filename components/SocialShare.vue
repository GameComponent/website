...
<template>
  <div>
    ...
    <a class="resp-sharing-button__link" :href="`https://twitter.com/intent/tweet/?text=${description}&url=${currentUrl}`" target="_blank" rel="noopener" aria-label="">
    ...
    <a class="resp-sharing-button__link" :href="`https://www.linkedin.com/shareArticle?mini=true&url=${currentUrl}&title=${description}&summary=${description}&source=${currentUrl}`" target="_blank" rel="noopener" aria-label="">
    ...
    <a class="resp-sharing-button__link" :href="`https://reddit.com/submit/?url=${currentUrl}&resubmit=true&title=${description}`" target="_blank" rel="noopener" aria-label="">
    ...
    <a class="resp-sharing-button__link" :href="`https://news.ycombinator.com/submitlink?u=${currentUrl}&t=${description}`" target="_blank" rel="noopener" aria-label="">
...
export default class SocialShare extends Vue {
  ...
  get currentUrl() {
    if (this.url && this.url.length > 0) return this.url;
