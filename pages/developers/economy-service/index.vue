...
<template>
  <div>
    <section class="background--light-green">
      <div class="container container--top-spacer mx-auto pt-32 pb-8 px-16"></div>
    </section>
        ...
        <div class="pt-16 pb-32 px-8">
          <div class="pb-16">
            ...
            <p class="text-grey-darker mt-4 text-xl leading-normal" style="letter-spacing: 0.5px;">
              Better documentation is in the making. Tutorials, examples will follow soon. As of right now you can view the specification.
            </p>
          </div>

          <div>
          <!-- Installation guide -->
            <div class="w-full border border-grey rounded-sm button--shadow mt-8">
              <div class="p-16">

                <h2 class="text-black text-3xl leading-tight">
                  Installation guide
                </h2>
                <p class="text-grey-darker leading-normal mt-4">
                  Follow these instructions to run the service on your own metal.
                </p>
                <div class="mt-8">
                  <nuxt-link
...
@Component
export default class DevelopersEconomy extends Vue {
  public head () {
    return {
      title: 'GameComponent - Economy service documentation'
    };
  }
}
</script>
